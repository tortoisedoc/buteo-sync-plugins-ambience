...
extern "C" CalDavPlugin* createPlugin(const QString& pluginName,
        const Buteo::SyncProfile& profile,
        Buteo::PluginCbInterface *cbInterface)
{
    return new CalDavPlugin(pluginName, profile, cbInterface);
}

extern "C" void destroyPlugin(CalDavPlugin *client)
{
    delete client;
}

CalDavPlugin::CalDavPlugin(const QString& pluginName,
        const Buteo::SyncProfile& profile,
        Buteo::PluginCbInterface *cbInterface) :
...
/**
  ...
  */
void
CalDavPlugin::abortSync(Sync::SyncStatus status)
{
    FUNCTION_CALL_TRACE;
...
/**
  ...
  */
void
CalDavPlugin::syncStateChanged(MyProtocol::SyncState state)
{
...
/**
  ...
  */
void
CalDavPlugin::syncFinished(MyProtocol::SyncState state)
{
...
/**
  ...
  */
void
CalDavPlugin::storageAccquired(QString mimeType)
{
    FUNCTION_CALL_TRACE;
...
/**
  ...
  */
void
CalDavPlugin::receiveItemProcessed(
...
/**
  ...
  */
Buteo::SyncResults
CalDavPlugin::getSyncResults() const
{
    FUNCTION_CALL_TRACE;
...
/**
  ...
  */
void
CalDavPlugin::connectivityStateChanged(Sync::ConnectivityType aType,
        bool aState)
{
    FUNCTION_CALL_TRACE;
...
CalDavPlugin::resolveSyncDirection(const MyProtocol::SyncInitiator& initiator)
{
    FUNCTION_CALL_TRACE;
...
CalDavPlugin::resolveConflictResolutionPolicy (const MyProtocol::SyncInitiator& initiator)
{
    FUNCTION_CALL_TRACE;
...
/**
  ...
  */
void
CalDavPlugin::generateResults (bool successful)
{
    FUNCTION_CALL_TRACE;
