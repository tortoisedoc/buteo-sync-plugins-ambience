...
#ifndef CalDavPlugin_H
#define CalDavPlugin_H
 ...
 *
 */
class CalDavPlugin : public Buteo::ClientPlugin
{
    Q_OBJECT;
public:
     ...
     */
    CalDavPlugin ( const QString& pluginName,
...
/*! \brief Creates CalDavPlugin client plugin
 *
 * @param aPluginName Name of this client plugin
...
/*! \brief Destroys CalDavPlugin client plugin
 *
 * @param aServer CalDavPlugin client plugin instance to destroy
 */
