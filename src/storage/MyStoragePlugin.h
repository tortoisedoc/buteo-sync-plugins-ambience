 ...
 *
 */
#ifndef MyStoragePlugin_H
#define MyStoragePlugin_H
...
class MyStoragePlugin : public Buteo::StoragePlugin
{
...
public:
     ...
     *
     */
    MyStoragePlugin(const QString& aPluginName);

    /*! \brief Destructor
     *
     */
    virtual ~MyStoragePlugin();
...
private:
    ...
    MyStoragePlugin::OperationStatus mapErrorStatus(const QContactManager::Error &aContactError) const;
